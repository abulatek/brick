#!/bin/bash
#SBATCH --job-name=imaging_151_spw29	  # Job name
#SBATCH --mail-user=abulatek@ufl.edu	  # Where to send mail
#SBATCH --mail-type=END,FAIL		      # Mail events (NONE, BEGIN, END, FAIL, ALL)
#SBATCH --output imaging_151_spw29_%j.log # Output and error log name
...
export LOGFILENAME='casa_clean_ab_151_spw29_2sigma.log'
...
xvfb-run -d ${CASA66} --logfile=${LOGFILENAME}  --nogui --nologger -c "execfile('/blue/adamginsburg/abulatek/brick/scripts/imaging/imaging_source_ab_151_spw29.py')"
