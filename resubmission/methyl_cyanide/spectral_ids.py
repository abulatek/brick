...
def line_ids(fn):
    ...
    for labelid in range(1,ct+1):
        ...
        sq = Splatalogue.query_lines(frq-0.2*u.GHz, frq+0.2*u.GHz, # 30/3e5 original lower bound
                                     chemical_name='CH3CN', energy_max=140, energy_type='eu_k', only_astronomically_observed=True)
