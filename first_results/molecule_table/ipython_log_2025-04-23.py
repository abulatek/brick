########################################################
# Started Logging At: 2025-04-23 14:09:43
########################################################
########################################################
# # Started Logging At: 2025-04-23 14:09:43
########################################################
########################################################
# Started Logging At: 2025-04-23 14:10:12
########################################################
########################################################
# # Started Logging At: 2025-04-23 14:10:12
########################################################
...
########################################################
# Started Logging At: 2025-04-23 14:11:43
########################################################
########################################################
# # Started Logging At: 2025-04-23 14:11:43
########################################################
...
########################################################
# Started Logging At: 2025-04-23 14:24:08
########################################################
########################################################
# # Started Logging At: 2025-04-23 14:24:09
########################################################
import numpy as np
import pyspeckit
from pyspeckit.spectrum.models.lte_molecule import get_molecular_parameters
...
plt.savefig('/blue/adamginsburg/abulatek/brick/first_results/figures/line_density_proposal_adamrerun.pdf', facecolor = 'w', edgecolor = 'w', bbox_inches = 'tight')
plt.savefig('/blue/adamginsburg/abulatek/brick/first_results/figures/line_density_proposal_adamrerun.png', dpi = 250, bbox_inches = 'tight')
plt.show()
# Use that table for ALMA Cycle 12 resubmission
fig = plt.figure(figsize = (23, 7)) # 23, 7 for ALMA proposal
gs = fig.add_gridspec(2, hspace = 0, height_ratios = [2, 1])
